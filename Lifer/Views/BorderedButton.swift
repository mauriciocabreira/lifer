...
//  OnTheMap
//
//  Created by Mauricio A Cabreira on 10/09/17.
...
//  let lighterCoral = UIColor(red: 0.196, green: 0.24, blue: 0.78, alpha:1.0)
  let darkerCoral = UIColor(red: 0.74, green: 0.23, blue: 0.108, alpha:1.0)
  let lighterCoral = UIColor.orange
  ...
  private func themeBorderedButton() {
    ...
    highlightedBackingColor = darkerCoral
    backingColor = lighterCoral
    backgroundColor = lighterCoral
